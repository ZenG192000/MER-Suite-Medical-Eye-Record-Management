<title>MER Suite | MER Repository</title>
<?php
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button type="button" class="btn btn-primary" style="border: none; border-radius: 60px; padding: 10px 13px; margin-bottom: 10px; background-color: #073f7f;" id="modalbtn" data-toggle="modal" data-target="#patientModal">
                               <i class="fa-sharp fa-solid fa-file-circle-plus fa-beat-fade"></i>
                            </button>
                ...
                <!-- Modal -->
                <div class="modal fade" id="patientModal" data-backdrop="static" data-keyboard="true" tabindex="-1" aria-labelledby="MER-ModalLabel" aria-hidden="true">
                    <!-- </div> -->
                    ...
                    <div class="col-2">
                      <label class=" col-form-label">ADD</label>
                            ...
                            <div class="modal-footer">
                                ...
                                <button id="submitMer" type="submit" class="btn btn-primary">SAVE</button>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="patientModal1" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="patientModalLabel" aria-hidden="true">
        ...
        <div class="modal fade" id="editMer2" tabindex="-1" aria-labelledby="patientModalLabel" aria-hidden="true">
            <!-- <div class="modal fade" id="patientModal" tabindex="-1" role="dialog" aria-labelledby="patientModalLabel" aria-hidden="true"> -->
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="ViewMerModal">
                            <input type="text" name="id11" class="form-control" id="id11" hidden>
                            <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <input type="text" class="autocomplete form-control" oninput="myFunction1()" name="edPirID11" id="edPirID11">
                                                </div>
                                                ...
                                                <div class="form-group col-md-5">
                                                    <input type="text" class="form-control" name="edPatientName11" id="edPatientName11" readonly>
                                                </div>
...
<label class=" col-form-label">ADD</label>
                                    ...
                                    <div id="OD-tbl" class="container">
                                        ...
                                        <div class="form-group row justify-content-center">
                                            ...
                                            <div class="col-12 col-md-2">
                                                <select type="od-box" class="form-control" id="edSPHOD11" name="edSPHOD11">
                                                    <option value=""></option>
                                                    <?php
                                                    // Generate age options dynamically using PHP
                                                    for ($SPHOD = -25; $SPHOD <= 15; $SPHOD++) {
                                            ...
                                            <label for="email" class="col-form-label"></label>
                                            <div class="col-12 col-md-2">
                                                <select type="od-box" class="form-control" id="edCYLOD11" name="edCYLOD11">
                                                    <option value=""></option>
                                                    <?php
                                                    // Generate age options dynamically using PHP
                                                    for ($CYLOS = -25; $CYLOS >= -400; $CYLOS--) {
                                            ...
                                            <label for="email" class="col-form-label"></label>
                                            <div class="col-12 col-md-2">
                                                <input type="od-box" class="form-control" id="edAXISOD11" name="edAXISOD11">
                                            </div>
                                            <!-- -------------------------------------------------------------------------- -->
                                            <label for="email" class="col-form-label"></label>
                                            <div class="col-12 col-md-2">
                                                <select type="od-box" class="form-control" name="edADDOD11" id="edADDOD11">
                                                    <option value=""></option>
                                                    <?php
                                                    // Generate age options dynamically using PHP
                                                    for ($ADDOD = 100; $ADDOD <= 300; $ADDOD += 25) {
                                    ...
                                    <div id="OS-tbl" class="container">
                                        ...
                                        <div class="form-group row justify-content-center">
                                            ...
                                            <div class="col-12 col-md-2">
                                                <select type="os-box" class="form-control" id="edSPHOS11" name="edSPHOS11">
                                                    <option value=""></option>
                                                    <?php
                                                    // Generate age options dynamically using PHP
                                                    for ($SPHOS = -25; $SPHOS <= 15; $SPHOS++) {
                                            ...
                                            <label for="email" class="col-form-label  "></label>
                                            <div class="col-12 col-md-2">
                                                <select type="os-box" class="form-control" id="edCYLOS11" name="edCYLOS11">
                                                    <option value=""></option>
                                                    <?php
                                                    // Generate age options dynamically using PHP
                                                    for ($CYLOS = -25; $CYLOS >= -400; $CYLOS--) {
                                            ...
                                            <label for="email" class="col-form-label  "></label>
                                            <div class="col-12 col-md-2">
                                                <input type="os-box" class="form-control" id="edAXISOS11" name="edAXISOS11">
                                            </div>
                                            <!-- -------------------------------------------------------------------------- -->
                                            <label for="email" class="col-form-label "></label>
                                            <div class="col-12 col-md-2">
                                                <select type="os-box" class="form-control" id="edADDOS11" name="edADDOS11">
                                                    <option value=""></option>
                                                    <?php
                                                    // Generate age options dynamically using PHP
                                                    for ($ADDOS = 100; $ADDOS <= 300; $ADDOS += 25) {
                                    ...
                                    <div id="OS-tbl" class="container ">
                                        ...
                                        <div class="form-group row justify-content-center">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <select type="lens-box" class="form-control" id="edLens11" name="edLens11">
                                                    <option value=""></option>
                                                    <option value="Single Vision">Single Vision</option>
                                                    <option value="Bifocal (regular)">Bifocal (regular)</option>
                                                    <option value="Bifocal (multicoated)">Bifocal (multicoated)</option>
                                            ...
                                            <label for="PD" class="col-form-label "> PD</label>
                                            <div class="col-12 col-md-4">
                                                <input type="pd-box" class="form-control" id="edPD11" name="edPD11">
                                            </div>
                                    ...
                                    <div class="container ml-5 mt-5">
                                        <div class="form-group row ml-5">
                                            <label for="recordBy" class="col-form-label ml-4">Recorded By:</label>
                                            <div class="col-5 ">
                                                <input type="text" class="form-control" id="edRecordedBy11" name="edRecordedBy11" readonly>
                                            </div>
                                        </div>
                                    </div>
...
<label class=" col-form-label">ADD</label>
                    ...
                    <div class="modal-footer">
                        <!-- <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button> -->
                        <button id="edmerfs" type="submit" class="btn btn-primary">SAVE</button>
                    </div>
                    </form>
                </div>
