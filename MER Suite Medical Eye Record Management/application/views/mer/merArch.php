<title>MER Suite | MER Archived</title>
<?php
...
?>
    ...
    ?>
    <?php if ($user_info->AccessType == 'Optometrist') {  ?>
        <li id="Opto-Arcv-btn" class="dropdown" style="background-color: #ffffff;">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="container-fluid text-md-right mt-1">
                    <div class="row">
                        <div class="col-md-12">
                            <button id="delete-button3" class="btn btn-warning mb-3"><i class="fa-duotone fa-recycle fa-fade fa-xl"></i></button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-offset-5 col">
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    <table id="example10" class="table">
                                        <thead>
                                            <tr>
                                                <th>Select</th>
                                                <th>Mer No.</th>
