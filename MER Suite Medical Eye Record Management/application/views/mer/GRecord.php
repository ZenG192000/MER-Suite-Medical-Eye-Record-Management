<title>MER Suite | MER Gen-Record</title>
<?php
                    ...
                    <div class="form-group">
                        ...
                        <form id="filterForm">
                            <div class="form-row align-items-center">
                                ...
                                <div class="col-sm-2">
                                    <input type="date" id="start_date" class="form-control" name="start_date" onchange="filterTable()">
                                </div>
                                <label for="end_date">End Date:</label>
                                <div class="col-sm-2">
                                    <input type="date" id="end_date" class="form-control" name="end_date" onchange="filterTable()">
                                </div>
                                <a href="#" id="exportButton" class="btn btn-warning mt-2 mb-2" onclick="exportToExcel()"><i class="fa-solid fa-download fa-fade"></i>Generate</a>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="col-md-offset-5 col">
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    <table id="tableforGen" class="table">
                                        <thead>
                                            <tr>
                                                <th>Mer No.</th>
                                                <th>PIR No.</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($files as $file) : ?>
                                                <tr>
                                                    <td><?= $file ?></td>
                                                    <td>
                                                        <a href="<?= base_url('mer/downloads/') . $file ?>" class="btn btn-primary">Download</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
