                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <input type="text" class="autocomplete form-control" oninput="myFunction1()" name="edPirID11" id="edPirID11" readonly>
                                                    </div>
...
<label class=" col-form-label">ADD</label>
                                        ...
                                        <div id="OD-tbl" class="container">
                                            ...
                                            <div class="form-group row justify-content-center">
                                                ...
                                                <div class="col-12 col-md-2">
                                                    <select type="od-box" class="form-control" id="edSPHOD11" name="edSPHOD11" readonly>
                                                        <option value=""></option>
                                                        <?php
                                                        // Generate age options dynamically using PHP
                                                        for ($SPHOD = -25; $SPHOD <= 15; $SPHOD++) {
                                                ...
                                                <label for="email" class="col-form-label"></label>
                                                <div class="col-12 col-md-2">
                                                    <select type="od-box" class="form-control" id="edCYLOD11" name="edCYLOD11" readonly>
                                                        <option value=""></option>
                                                        <?php
                                                        // Generate age options dynamically using PHP
                                                        for ($CYLOS = -25; $CYLOS >= -400; $CYLOS--) {
                                                ...
                                                <label for="email" class="col-form-label"></label>
                                                <div class="col-12 col-md-2">
                                                    <input type="od-box" class="form-control" id="edAXISOD11" name="edAXISOD11" readonly>
                                                </div>
                                                <!-- -------------------------------------------------------------------------- -->
                                                <label for="email" class="col-form-label"></label>
                                                <div class="col-12 col-md-2">
                                                    <select type="od-box" class="form-control" name="edADDOD11" id="edADDOD11" readonly>
                                                        <option value=""></option>
                                                        <?php
                                                        // Generate age options dynamically using PHP
                                                        for ($ADDOD = 100; $ADDOD <= 300; $ADDOD += 25) {
                                        ...
                                        <div id="OS-tbl" class="container">
                                            ...
                                            <div class="form-group row justify-content-center">
                                                ...
                                                <div class="col-12 col-md-2">
                                                    <select type="os-box" class="form-control" id="edSPHOS11" name="edSPHOS11" readonly>
                                                        <option value=""></option>
                                                        <?php
                                                        // Generate age options dynamically using PHP
                                                        for ($SPHOS = -25; $SPHOS <= 15; $SPHOS++) {
                                                ...
                                                <label for="email" class="col-form-label  "></label>
                                                <div class="col-12 col-md-2">
                                                    <select type="os-box" class="form-control" id="edCYLOS11" name="edCYLOS11" readonly>
                                                        <option value=""></option>
                                                        <?php
                                                        // Generate age options dynamically using PHP
                                                        for ($CYLOS = -25; $CYLOS >= -400; $CYLOS--) {
                                                ...
                                                <label for="email" class="col-form-label  "></label>
                                                <div class="col-12 col-md-2">
                                                    <input type="os-box" class="form-control" id="edAXISOS11" name="edAXISOS11" readonly>
                                                </div>
                                                <!-- -------------------------------------------------------------------------- -->
                                                <label for="email" class="col-form-label "></label>
                                                <div class="col-12 col-md-2">
                                                    <select type="os-box" class="form-control" id="edADDOS11" name="edADDOS11" readonly>
                                                        <option value=""></option>
                                                        <?php
                                                        // Generate age options dynamically using PHP
                                                        for ($ADDOS = 100; $ADDOS <= 300; $ADDOS += 25) {
                                        ...
                                        <div id="OS-tbl" class="container ">
                                            ...
                                            <div class="form-group row justify-content-center">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <select type="lens-box" class="form-control" id="edLens11" name="edLens11" readonly>
                                                        <option value=""></option>
                                                        <option value="Single Vision">Single Vision</option>
                                                        <option value="Bifocal (regular)">Bifocal (regular)</option>
                                                        <option value="Bifocal (multicoated)">Bifocal (multicoated)</option>
                                                ...
                                                <label for="PD" class="col-form-label "> PD</label>
                                                <div class="col-12 col-md-4">
                                                    <input type="pd-box" class="form-control" id="edPD11" name="edPD11" readonly>
                                                </div>
